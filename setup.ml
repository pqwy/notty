...
(* OASIS_START *)
(* DO NOT EDIT (digest: cd4a0244534aa0a2843ed91f2df966ac) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          synopsis = "stuff";
          description = Some [OASISText.Para "stuff"];
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "demos";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "notty"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\255\227~\249ZM\027\212\163@\141|\165t\134\177";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
