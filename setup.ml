...
(* OASIS_START *)
(* DO NOT EDIT (digest: a9d5af730de4c700d86ef0c44e35ecce) *)
(*
...
let setup_t =
  {
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   [
                      "-use-ocamlfind";
                      "-docflags '-colorize-code -charset utf-8 -hide Notty -hide Pervasives'"
                   ];
                 run_path = "doc"
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/pqwy/notty";
          synopsis = "Declaring terminals";
          description =
            Some [OASISText.Para "A declarative terminal graphics library"];
          categories = [];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build Lwt support";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("uucp", None);
                           FindlibPackage ("uuseg", None);
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "notty";
                           FindlibPackage ("unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["native/winsize.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true,
                   ...
                   {
                      lib_modules = ["Notty_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "notty";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "notty_unix"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "testpatterns.ml"});
               Executable
                 ({
                     cs_name = "letters";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "letters.ml"});
               Executable
                 ({
                     cs_name = "keys";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "keys.ml"});
               Executable
                 ({
                     cs_name = "colors";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "sierpinski.ml"});
               Executable
                 ({
                     cs_name = "sierpinski_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "notty"; InternalLibrary "notty_lwt"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "sierpinski_lwt.ml"});
               Executable
                 ({
                     cs_name = "cuts";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "cuts.ml"});
               Executable
                 ({
                     cs_name = "thisbig";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "thisbig.ml"});
               Executable
                 ({
                     cs_name = "runes";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "runes.ml"});
               Executable
                 ({
                     cs_name = "crops";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "crops.ml"});
               Executable
                 ({
                     cs_name = "mouse";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "mouse.ml"});
               Executable
                 ({
                     cs_name = "life";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "life.ml"});
               Executable
                 ({
                     cs_name = "linear";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "d&\011\005\192B\222)\152$\135\027\225\026f~";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
